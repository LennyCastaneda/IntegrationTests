...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ColumnPicker", "\tShow that the Column Picker modal can be used to add, remove and reorder the vis" +
                    "ible columns in a grid view.", ProgrammingLanguage.CSharp, new string[] {
                        "Chrome"});
