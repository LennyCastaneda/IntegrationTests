...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Filters", "\tShow that through the Filter Picker a user can change the data visible in the gr" +
                    "idview.", ProgrammingLanguage.CSharp, new string[] {
                        "Chrome"});
